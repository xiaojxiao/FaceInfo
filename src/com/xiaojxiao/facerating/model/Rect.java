...
public class Rect
{
	...
	{
		this(center.x - (width / 2f), center.y - (height / 2f), center.x + (width / 2f), center.y + (height / 2f));
	}
	...
	public String toString()
	{
		...
		builder.append("Rect [bottom=").append(bottom).append(", left=").append(left).append(", right=").append(right)
